...
export default function InfoCard(prop: CardProp) {
  return (
    <div className="w-full h-[157px] p-5 lg:px-[30px] lg:pb-[30px] md:h-[337px] lg:h-[439px] bg-sec rounded-[20px] flex items-center justify-center md:justify-normal md:flex-col md:text-center">
